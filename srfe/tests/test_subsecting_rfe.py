...
class TestSRFE(TestCase):
    @classmethod
    def setUpClass(cls):
        cls.X, cls.y = make_friedman1(n_samples=50, n_features=10,
                                      random_state=0)
        cls.X_c, cls.y_c = make_classification(n_samples=1000, n_features=10,
    ...
    def test_classification(self):
        ...
        selector = SubsectingRFE(estimator, cv=5, method="fibonacci")
